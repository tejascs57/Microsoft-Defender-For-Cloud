...
#     # Construct the API endpoint URL for fetching pricing information
#     $pricingApiUrl = "https://management.azure.com/subscriptions/$SubscriptionId/resourceGroups/$ResourceGroup/providers/Microsoft.Compute/virtualMachines/$vmName/providers/Microsoft.Security/pricings/VirtualMachines?api-version=2024-01-01"

#     # Make the GET request to fetch pricing information
#     try {
#         $pricingResponse = Invoke-RestMethod -Uri $pricingApiUrl -Method Get -Headers @{Authorization = "Bearer $accessToken"}
...
#         Write-Host "SubPlan for VM ${vmName}: ${subPlan}"
#     } 
#     catch {
